...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir and (epoch > 0) and (epoch % args.save_per_epochs == 0 or epoch + 1 == args.epochs):
            misc.save_model(
        ...
        log_stats = {**{f'train_{k}': v for k, v in train_stats.items()},
                        'epoch': epoch,}
        if epoch > 0 and (epoch % args.save_per_epochs == 0 or epoch + 1 == args.epochs):
